...
export async function renderRateConPdf(svc, chargeSetId, tenantId) {
  const { data: cs, error } = await svc
    ...
    .select(`
      ...
      order:orders(
        order_number, customer_reference, container_number, chassis_number,
