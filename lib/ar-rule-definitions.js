...
import { LOAD_TYPES } from './constants/load-types.js';
...
export const AR_RULES = [
  // ── Load & Customer Context ──
  {
    ...
    // Sourced from lib/constants/load-types.js so adding a new load type
    // (e.g. chassis_reposition) automatically extends the AR rule picker
    // with no manual sync required.
    options: LOAD_TYPES.map((t) => ({ value: t.value, label: t.label })),
  },
  {
    key: 'customer',
    label: 'Customer',
