 ...
 *
 * Wrapped with the resilience layer — every .from() / .rpc() call
 * goes through retry + circuit breaker. This is the entry point
 * used by ~133 API routes, so wrapping here is what actually
 * activates Tier 0's resilience for the bulk of the app.
 */
