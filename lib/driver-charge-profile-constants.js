...
// ── Dispatcher States (for Between Statuses calculation) ─────
// These are the derivable states from the dispatcher state machine.
// Use them as Calculate From / Calculate To endpoints to bill the
// elapsed time between two operational milestones. Time-based UOMs
// (per_hour, per_day, per_15_min, etc.) are the natural fit.
export const DISPATCHER_STATE_OPTIONS = [
  { value: 'enroute_pull', label: 'Enroute To Chassis' },
  { value: 'arrived_pull', label: 'Arrived At Chassis' },
  { value: 'enroute_pickup', label: 'Enroute To Pick Container' },
  { value: 'arrived_pickup', label: 'Arrived At Pick Container' },
  { value: 'enroute_drop', label: 'Enroute To Drop Container' },
  { value: 'arrived_drop', label: 'Dropped' },
  { value: 'enroute_hook', label: 'Enroute To Hook Container' },
  { value: 'arrived_hook', label: 'Arrived At Hook Container' },
  { value: 'enroute_deliver', label: 'Enroute To Deliver Load' },
  { value: 'arrived_deliver', label: 'Arrived At Deliver Load' },
  { value: 'enroute_return', label: 'Enroute To Return Chassis' },
  { value: 'arrived_return', label: 'Arrived At Return Chassis' },
