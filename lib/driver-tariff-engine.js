  ...
  for (const charge of charges) {
    ...
    if (basedOn === 'ar_invoice') {
      ...
      if (chargeCode) {
        ...
        // No code — use first non-percentage driver charge (unresolved bases
        // have amount_cents===null so they won't be found by amount_cents > 0;
        // in that case baseCents stays 0 and the percentage charge is left as-is).
