      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-slate-400 mt-1">
              Regional offices and operational divisions. Assign users, customers, and loads to branches for scoped visibility.
            </p>
          </div>
          {isSuperAdmin && (
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-sm text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
          />
        </div>
        ...
        {/* Branch list */}
        {loading ? (
          <div className="rounded-xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-10 text-center text-sm text-gray-400 dark:text-slate-500">
            Loading...
          </div>
        ) : branches.length === 0 ? (
          <div className="rounded-xl border border-dashed border-gray-300 dark:border-slate-700 bg-gray-50 dark:bg-slate-900 p-10 text-center">
            <GitBranch className="w-10 h-10 text-gray-300 dark:text-slate-600 mx-auto mb-3" />
            <div className="text-sm font-medium text-gray-500 dark:text-slate-400">No branches yet</div>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <div className="flex items-center gap-1 text-xs text-gray-500 dark:text-slate-400 bg-gray-100 dark:bg-slate-800 px-2 py-1 rounded-lg" title="Assigned users">
                      <UsersIcon className="w-3 h-3" />
                      {branch.user_count || 0}
                    </div>
                    <div className="flex items-center gap-1 text-xs text-gray-500 dark:text-slate-400 bg-gray-100 dark:bg-slate-800 px-2 py-1 rounded-lg" title="Assigned customers">
      ...
      {modalOpen && (
        ...
        >
          <form onSubmit={handleSave} className="space-y-4">
            ...
            {/* Location */}
            <div className="text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wide pt-2">
              Location
            </div>
            ...
            <div className="flex gap-1 bg-gray-100 dark:bg-slate-800 rounded-lg p-1">
              {[
                ...
                <button
                  ...
                  className={`flex-1 inline-flex items-center justify-center gap-1.5 rounded-md py-2 text-xs font-semibold transition-colors ${
                    assignTab === tab.id
